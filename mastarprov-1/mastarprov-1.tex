...
Asserts:
\begin{enumerate}
\item $wordList$ innehåller bara ord med samma antal av samtliga bokstäver till med icke med $letter$
...
\item Alla listor i $newLists$ fram t.o.m. $list$ har använts i rekursiva anrop med en bokstav som är närmare ett steg närmare ö än $letter$.
\end{enumerate}
